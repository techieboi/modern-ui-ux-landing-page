...
export default function Navbar({ scrolled }) {
    ...
    return <nav className={`fixed top-0 w-full z-50 transition-all duration-300 ${scrolled ? "bg-slate-950/20 backdrop-blur-sm" : "bg-slate-950/20 backdrop-blur-sm"}`}>
            ...
            <div className='flex justify-between items-center h-14 sm:h-16 md:h-20'>
                <div className="flex items-center space-x-2 group cursor-pointer">
                    ...
                    <span className="text-lg sm:text-xl md:text-2xl font-medium">
                        <span className="text-white">CS50</span>
                        <span className="text-yellow-200">ddb</span>
                    </span>
                </div>
